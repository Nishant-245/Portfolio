...
const skills = {
  ...
  databases: ["MongoDB", "MySQL", "Appwrite", "Firebase"],
  tools: ["React", "Node.js", "Git", "Pyspark", "Apache spark", "Mui"],
  others: ["AWS", "VSCode", "Jupyter Notebook"],
};
    ...
    <div className="wrapper">
      ...
      <div className="container">
        ...
        <footer>
          ...
          <span>© Copyright 2024. Made by Nishant</span>
        </footer>
      </div>
    </div>
  );
